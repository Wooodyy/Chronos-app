export const kz = {
  ...
  // Voice Input
  "voiceInput.title.permissionError": "Рұқсат қажет",
  "voiceInput.title.result": "Нәтиже",
  "voiceInput.title.input": "Дауыспен енгізу",

  "voiceInput.button.close": "Жабу",
  "voiceInput.button.startRecordingPrompt": "Жазуды бастау үшін микрофонды басыңыз",
  "voiceInput.button.listening": "Тыңдалуда...",
  "voiceInput.button.cancel": "Болдырмау",
  "voiceInput.button.retry": "Қайталау",
  "voiceInput.button.rerecord": "Қайта жазу",
  "voiceInput.button.newInput": "Жаңа енгізу",
  "voiceInput.button.save": "Сақтау",
  "voiceInput.button.saving": "Сақталуда...",
  "voiceInput.button.done": "Дайын",

  "voiceInput.status.initializing": "Инициализация...",
  "voiceInput.status.noMicAccessTitle": "Микрофонға қол жеткізу жоқ",
  "voiceInput.status.noMicAccessDesc": "Браузер параметрлерінде микрофонға қол жеткізуге рұқсат етіңіз.",
  "voiceInput.status.analyzingSpeech": "Сөйлеуді талдау...",
  "voiceInput.status.processingAI": "AI өңдеуде...",
  "voiceInput.status.recognizedLabel": "Танылды:",
  "voiceInput.status.noSpeechDetectedTitle": "Ештеңе танылмады",
  "voiceInput.status.noSpeechDetectedDesc": "Дауысыңызды қаттырақ шығарыңыз немесе микрофонды тексеріңіз.",
  "voiceInput.status.aiErrorTitle": "AI өңдеу қатесі",
  "voiceInput.status.aiErrorDefault": "AI арқылы сұранысты өңдеу мүмкін болмады.",
  "voiceInput.status.yourRequestLabel": "Сіздің сұранысыңыз:",
  "voiceInput.status.noDataToShow": "Көрсетілетін деректер жоқ.",
  "voiceInput.status.noDataOrError": "Көрсетілетін деректер жоқ немесе қате орын алды.",
  "voiceInput.status.browserNoSupport": "Сіздің браузеріңіз сөйлеуді тануды қолдамайды.",

  "voiceInput.card.unknownTypeTitle": "Түрі анықталмады",
  "voiceInput.card.unknownTypeDesc": "AI сіздің сұранысыңызды жіктей алмады.",
  "voiceInput.card.recognizedTextLabel": "Танылған мәтін:",
  "voiceInput.card.task": "Тапсырма",
  "voiceInput.card.reminder": "Еске салғыш",
  "voiceInput.card.note": "Жазба",
  "voiceInput.card.untitled": "Тақырыпсыз",
  "voiceInput.card.noDescription": "Сипаттамасы жоқ.",
  "voiceInput.card.attention": "Назар аударыңыз",

  "voiceInput.toast.errorTitle": "Қате",
  "voiceInput.toast.loginRequiredDesc": "Сақтау үшін жүйеге кіру қажет.",
  "voiceInput.toast.noDataToSaveTitle": "Сақталатын деректер жоқ",
  "voiceInput.toast.noDataToSaveDesc": "Сақталатын деректерді тану мүмкін болмады.",

  "voiceInput.toast.taskSavedTitle": "Тапсырма сақталды",
  "voiceInput.toast.taskSavedDesc": "Жаңа тапсырма сәтті қосылды.",
  "voiceInput.toast.reminderSavedTitle": "Еске салғыш сақталды",
  "voiceInput.toast.reminderSavedDesc": "Жаңа еске салғыш сәтті қосылды.",
  "voiceInput.toast.noteSavedTitle": "Жазба сақталды",
  "voiceInput.toast.noteSavedDesc": "Жаңа жазба сәтті қосылды.",

  "voiceInput.toast.unknownTypeTitle": "Белгісіз түр",
  "voiceInput.toast.unknownTypeDesc": "Сақталатын жазба түрін анықтау мүмкін болмады.",
  "voiceInput.toast.saveErrorTitle": "Сақтау қатесі",
  "voiceInput.toast.saveErrorDesc": "{type} сақталмады.",
  "voiceInput.toast.networkErrorTitle": "Желі қатесі",
  "voiceInput.toast.networkErrorDesc": "{type} сақтау кезінде қате орын алды.",
