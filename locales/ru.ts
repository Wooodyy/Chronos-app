export const ru = {
  ...
  "voiceInput.title.input": "Голосовой ввод",

  "voiceInput.button.close": "Закрыть",
  "voiceInput.button.startRecordingPrompt": "Нажмите на микрофон, чтобы начать запись",
  "voiceInput.button.listening": "Говорите...",
  "voiceInput.button.cancel": "Отменить",
  "voiceInput.button.retry": "Повторить",
  "voiceInput.button.rerecord": "Перезаписать",
  "voiceInput.button.newInput": "Новый ввод",
  "voiceInput.button.save": "Сохранить",
  "voiceInput.button.saving": "Сохранение...",
  "voiceInput.button.done": "Готово",

  "voiceInput.status.initializing": "Инициализация...",
  "voiceInput.status.noMicAccessTitle": "Нет доступа к микрофону",
  "voiceInput.status.noMicAccessDesc": "Пожалуйста, разрешите доступ к микрофону в настройках браузера.",
  "voiceInput.status.analyzingSpeech": "Анализ речи...",
  "voiceInput.status.processingAI": "Обработка ИИ...",
  "voiceInput.status.recognizedLabel": "Распознано:",
  "voiceInput.status.noSpeechDetectedTitle": "Ничего не распознано",
  "voiceInput.status.noSpeechDetectedDesc": "Пожалуйста, говорите громче или проверьте работу микрофона.",
  "voiceInput.status.aiErrorTitle": "Ошибка обработки ИИ",
  "voiceInput.status.aiErrorDefault": "Не удалось обработать запрос через ИИ.",
  "voiceInput.status.yourRequestLabel": "Ваш запрос:",
  "voiceInput.status.noDataToShow": "Нет данных для отображения.",
  "voiceInput.status.noDataOrError": "Нет данных для отображения или произошла ошибка.",
  "voiceInput.status.browserNoSupport": "Ваш браузер не поддерживает распознавание речи.",

  "voiceInput.card.unknownTypeTitle": "Не удалось определить тип",
  "voiceInput.card.unknownTypeDesc": "ИИ не смог классифицировать ваш запрос.",
  "voiceInput.card.recognizedTextLabel": "Распознанный текст:",
  "voiceInput.card.task": "Задача",
  "voiceInput.card.reminder": "Напоминание",
  "voiceInput.card.note": "Заметка",
  "voiceInput.card.untitled": "Без заголовка",
  "voiceInput.card.noDescription": "Нет описания.",
  "voiceInput.card.attention": "Внимание",

  "voiceInput.toast.errorTitle": "Ошибка",
  "voiceInput.toast.loginRequiredDesc": "Необходимо войти в систему для сохранения.",
  "voiceInput.toast.noDataToSaveTitle": "Нет данных для сохранения",
  "voiceInput.toast.noDataToSaveDesc": "Не удалось распознать данные для сохранения.",

  "voiceInput.toast.taskSavedTitle": "Задача сохранена",
  "voiceInput.toast.taskSavedDesc": "Новая задача успешно добавлена.",
  "voiceInput.toast.reminderSavedTitle": "Напоминание сохранено",
  "voiceInput.toast.reminderSavedDesc": "Новое напоминание успешно добавлено.",
  "voiceInput.toast.noteSavedTitle": "Заметка сохранена",
  "voiceInput.toast.noteSavedDesc": "Новая заметка успешно добавлена.",

  "voiceInput.toast.unknownTypeTitle": "Неизвестный тип",
  "voiceInput.toast.unknownTypeDesc": "Не удалось определить тип записи для сохранения.",
  "voiceInput.toast.saveErrorTitle": "Ошибка сохранения",
  "voiceInput.toast.saveErrorDesc": "Не удалось сохранить {type}.",
  "voiceInput.toast.networkErrorTitle": "Ошибка сети",
  "voiceInput.toast.networkErrorDesc": "Произошла ошибка при попытке сохранить {type}.",
